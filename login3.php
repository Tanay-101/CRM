...
<body>
    <div class="form-box">
        ...
        <div class="img-area">
            ...
            <div class="form-area">
                <h3>Login In To See Your Pending Requests</h3>
                <form method="POST" action="login3.php">
                    ...
                    <div class="single-form">
                        ...
                        <br><br>
                        <a href="register.php" class="btn-secondary" id="tap" style="font-size: 15px; padding-left: 10px; color: white;">Haven't made a request yet? Register</a>
                    </div>
                </form>
